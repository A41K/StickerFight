...
const localStickers = [
    ...
    { name: "2020 Progress", url: "Stickers/2020 Progress.png", rarity: 'Uncommon' },
    { name: "2020 Storm The Hack", url: "Stickers/2020 Storm The Hack.png", rarity: 'Rare' },
    { name: "2021 Design Awards", url: "Stickers/2021 Design Awards.png", rarity: 'Common' },
    { name: "2025 Summer of Making", url: "Stickers/2025 Summer of Making.png", rarity: 'Epic' },
    { name: "AI Safety Campfire", url: "Stickers/AI Safety Campfire.png", rarity: 'Uncommon' },
    { name: "AI Safety Meme", url: "Stickers/AI Safety Meme.png", rarity: 'Common' },
    { name: "Adobe", url: "Stickers/Adobe.svg", rarity: 'Rare' },
    { name: "Airlines", url: "Stickers/Airlines.png", rarity: 'Uncommon' },
    { name: "All Fun Javascript", url: "Stickers/All Fun Javascript.svg", rarity: 'Common' },
    { name: "Anxiety", url: "Stickers/Anxiety.png", rarity: 'Common' },
    { name: "Apocalypse", url: "Stickers/Apocalypse.png", rarity: 'Rare' },
    { name: "Arcade", url: "Stickers/Arcade.png", rarity: 'Common' },
    { name: "Arrpheus", url: "Stickers/Arrpheus.png", rarity: 'Epic' },
    { name: "Assemble", url: "Stickers/Assemble.svg", rarity: 'Rare' },
    ...
    { name: "Athena Black", url: "Stickers/Athena Black.png", rarity: 'Uncommon' },
    ...
    { name: 'Duck on Boat', url: 'Stickers/Duck on Boat.png', rarity: 'Uncommon' },
    { name: 'Emergency Meeting', url: 'Stickers/Emergency Meeting.svg', rarity: 'Epic' },
    { name: 'Epoch Among Us', url: 'Stickers/Epoch Among Us.png', rarity: 'Common' },
    { name: 'Epoch Bubbly', url: 'Stickers/Epoch Bubbly.png', rarity: 'Uncommon' },
    ...
    { name: 'Find Out', url: 'Stickers/Find Out.png', rarity: 'Uncommon' },
    ...
    { name: 'Game Lab', url: 'Stickers/Game Lab.png', rarity: 'Uncommon' },
    { name: 'Grab', url: 'Stickers/Grab.png', rarity: 'Common' },
    { name: 'Hack Club HQ', url: 'Stickers/Hack Club HQ.png', rarity: 'Rare' },
    { name: 'Hack Cola', url: 'Stickers/Hack Cola.svg', rarity: 'Uncommon' },
    { name: 'Hack In The Club', url: 'Stickers/Hack In The Club.svg', rarity: 'Uncommon' },
    { name: 'Hack Ok Please', url:'Stickers/Hack Ok Please.png', rarity: 'Rare'},
    { name: 'Hack Strikes Back', url:'Stickers/Hack Strikes Back.svg', rarity: 'Common'},
    { name: 'Hack To The Future', url:'Stickers/Hack To The Future.svg', rarity: 'Epic'},
    { name: 'Hackaccino', url:'Stickers/Hackaccino.png', rarity: 'Uncommon'},
    { name: 'Hackers Assamble!', url:'Stickers/Hackers Assemble!.png', rarity: 'Common'},
    { name: 'HackHackClub', url:'Stickers/HackHackClub.png', rarity: 'Rare'},
    { name: 'Hacky New Year', url:'Stickers/Hacky New Year.png', rarity: 'Uncommon'},
    { name: 'HCB', url:'Stickers/Hcb.png', rarity: 'Uncommon'},
];
